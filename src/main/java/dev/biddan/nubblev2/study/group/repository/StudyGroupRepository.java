...
public interface StudyGroupRepository extends JpaRepository<StudyGroup, Long> {
    ...
    // 편의 메서드 - default로 구현
    default Map<Long, List<StudyGroup.ProgrammingLanguage>> getLanguagesMapByStudyGroupIds(List<Long> studyGroupIds) {
    ...
    default Map<Long, List<StudyGroup.DifficultyLevel>> getDifficultyLevelsMapByStudyGroupIds(List<Long> studyGroupIds) {
        if (studyGroupIds.isEmpty()) {
            return Map.of();
        }
